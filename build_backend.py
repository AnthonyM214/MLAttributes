...
def _entry_points_text() -> str:
    return "\n".join(
        [
            ...
            "pac-benchmark-v3 = places_attr_conflation.benchmark_v3:main",
            "pac-benchmark-v4 = places_attr_conflation.benchmark_v4:main",
            "pac-benchmark-v5 = places_attr_conflation.benchmark_v5:main",
            "pac-benchmark-v6 = places_attr_conflation.benchmark_v6:main",
            "pac-benchmark-full-replay = places_attr_conflation.benchmark_full_replay:main",
            "pac-benchmark-pooled = places_attr_conflation.benchmark_pooled:main",
            "pac-dashboard = places_attr_conflation.dashboard:main",
