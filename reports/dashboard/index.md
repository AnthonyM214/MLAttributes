...
- [x] Dashboard and comparison docs cleaned up - Current artifacts are surfaced from reports/dashboard/latest.json and the current test suite is documented as 222 tests passed.
...
| Santa Cruz challenge | 100.0% expected / 3.3% abstention | Raw resolver accuracy: 96.7%; high-confidence wrong: 0.0%; covers branch, government primary-phone, relay/fax/footer phone, department-location-vs-footer address, full-name/acronym, host-building name, tourism category, locator website, official-vs-social, title-cleaning, service-page category, program-tenant category, adjacent-facility category, and branch-specific website cases. |
...
| Test suite | 222 tests passed | Current repo comparison document records the full unit-test count as a reproducibility proof. |
...
- Expected-behavior accuracy (v1 / v2): 26.7% / 100.0%
- Expected-behavior abstention (v1 / v2): 76.7% / 3.3%
- Raw resolver accuracy: 96.7%
- Raw resolver abstention: 3.3%
