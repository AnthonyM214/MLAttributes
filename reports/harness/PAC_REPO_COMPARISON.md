...
| Artifact | Result |
| --- | --- |
| Unit tests | `218` tests passed |
| Santa Cruz expanded corpus | `24` episodes; targeted authoritative found rate `1.0`, fallback `0.0`; final accuracy `1.0` |
| Santa Cruz challenge corpus | `15` episodes across website, phone, address, category, and name; resolver v2 expected-behavior accuracy `1.0`, abstention rate `0.0667`, high-confidence-wrong rate `0.0`; v2 adds branch-context phone/address, office-vs-mailing address, official-vs-social website, official-vs-directory category, title-cleaned name, government primary-phone-vs-secondary-line, government room-address-vs-footer, and official phone-vs-fax cases without prefilled extraction |
...
- The local test suite passed on this checkout: `218` tests.
...
- The Santa Cruz challenge corpus adds `15` cases across all five core attributes for branch ambiguity, branch-context phone/address selection without prefilled extraction, office-vs-mailing address selection, official-vs-social website selection, official-vs-directory category selection, title-cleaned name selection, government primary-phone-vs-secondary-line selection, government room-address-vs-footer selection, official phone-vs-fax selection, stale archive conflict, and contact-page vs staff-page conflict.
