...
| Santa Cruz seed batch 6 | `10` episodes; expected-behavior accuracy `1.0`, abstention rate `0.5`, high-confidence-wrong rate `0.0`; sixth seed tranche with another abstention-heavy cross-city national coverage push |
...
- The local test suite passed on this checkout: `269` tests.
